 ...
 */
export class PullsCreateReviewCommentRequestSide extends S.Literal(
	"LEFT",
	"RIGHT",
) {}
 ...
 */
export class PullsCreateReviewCommentRequestStartSide extends S.Literal(
	"LEFT",
	"RIGHT",
	"side",
) {}
 ...
 */
export class PullsCreateReviewCommentRequestSubjectType extends S.Literal(
	"line",
	"file",
) {}

export class PullsCreateReviewCommentRequest extends S.Class<PullsCreateReviewCommentRequest>(
	 ...
	 * **Required when using multi-line comments unless using `in_reply_to`**. The `start_side` is the starting side of the diff that the comment applies to. Can be `LEFT` or `RIGHT`. To learn more about multi-line comments, see "[Commenting on a pull request](https://docs.github.com/articles/commenting-on-a-pull-request#adding-line-comments-to-a-pull-request)" in the GitHub Help documentation. See `side` in this table for additional context.
	 */
	start_side: S.optionalWith(PullsCreateReviewCommentRequestStartSide, {
		nullable: true,
	}),
	/**
	 ...
	 * The level at which the comment is targeted.
	 */
	subject_type: S.optionalWith(PullsCreateReviewCommentRequestSubjectType, {
		nullable: true,
	}),
}) {}
...
export class PullsCreateReplyForReviewCommentRequest extends S.Class<PullsCreateReplyForReviewCommentRequest>(
...
export class PullsUpdateBranchRequest extends S.Class<PullsUpdateBranchRequest>(
...
export const make = (
	...
	return {
		...
		pullsCreateReviewComment: (owner, repo, pullNumber, options) =>
			HttpClientRequest.post(
				`/repos/${owner}/${repo}/pulls/${pullNumber}/comments`,
			).pipe(
				HttpClientRequest.bodyUnsafeJson(options.payload),
		...
		pullsUpdateBranch: (owner, repo, pullNumber, options) =>
			HttpClientRequest.put(
...
export interface GitHubClient {
	 ...
	 * - **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
	 */
	readonly pullsCreateReviewComment: (
		owner: string,
		repo: string,
		pullNumber: string,
		options: {
			readonly params?:
				| typeof PullsCreateReviewCommentParams.Encoded
				| undefined;
			readonly payload: typeof PullsCreateReviewCommentRequest.Encoded;
		},
	) => Effect.Effect<
		typeof PullRequestReviewComment.Type,
		| HttpClientError.HttpClientError
		| ParseError
		| GitHubClientError<"BasicError", typeof BasicError.Type>
		| GitHubClientError<"ValidationError", typeof ValidationError.Type>
	 ...
	 * - **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
	 */
	readonly pullsCreateReplyForReviewComment: (
		owner: string,
		repo: string,
		pullNumber: string,
		commentId: string,
		options: {
			readonly params?:
				| typeof PullsCreateReplyForReviewCommentParams.Encoded
				| undefined;
			readonly payload: typeof PullsCreateReplyForReviewCommentRequest.Encoded;
		},
	) => Effect.Effect<
		typeof PullRequestReviewComment.Type,
		| HttpClientError.HttpClientError
	 ...
	 */
	readonly pullsUpdateBranch: (
		owner: string,
		repo: string,
		pullNumber: string,
		options: {
			readonly params?: typeof PullsUpdateBranchParams.Encoded | undefined;
			readonly payload: typeof PullsUpdateBranchRequest.Encoded;
		},
	) => Effect.Effect<
		typeof PullsUpdateBranch202.Type,
		| HttpClientError.HttpClientError
		| ParseError
		| GitHubClientError<"BasicError", typeof BasicError.Type>
		| GitHubClientError<"ValidationError", typeof ValidationError.Type>
